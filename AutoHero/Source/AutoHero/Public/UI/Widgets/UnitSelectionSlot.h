...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnSlotDropped, UUnitSelectionSlot*, UnitSlot,  FVector2D, MousePosition);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnSlotDragDetected, UUnitSelectionSlot*, UnitSlot,  FVector2D, MousePosition);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnSlotDragLeave, UUnitSelectionSlot*, UnitSlot,  FVector2D, MousePosition);
...
public:
	...
	// UFUNCTION()
	// void OnDropUnit(UDragDropOperation* InOperation);
protected:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Drag")
	TSubclassOf<UUserWidget> DragVisualClass;
	UPROPERTY()
	UUnitDragDropOperation* CurrentDragOperation;
